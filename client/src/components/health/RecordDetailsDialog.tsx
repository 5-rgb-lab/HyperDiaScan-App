...
export default function RecordDetailsDialog({
  ...
  return (
    ...
    >
      <DialogContent className="max-w-xl rounded-3xl shadow-2xl p-6 bg-white dark:bg-gray-900 max-h-[90vh] flex flex-col">
            ...
            <div className="space-y-6 pr-4">
              {selectedRecord.imageUrl && (
                <div className="w-full flex justify-center">
                  <img src={selectedRecord.imageUrl} alt={selectedRecord.foodName || 'scan image'} className="w-full max-h-64 object-contain rounded-md border" />
                </div>
              )}
