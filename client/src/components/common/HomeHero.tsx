  ...
  return (
    <div className="bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 rounded-2xl p-8 md:p-12 text-white shadow-2xl overflow-hidden relative">
      <div className="relative text-center space-y-6">
        ...
        {userProfile?.name && (
          <p className="text-blue-100 text-lg">Welcome back, <span className="font-semibold">{userProfile.name}</span>! Track your health journey with smart food analysis.</p>
        )}
